...
DXGI_FORMAT pixel_buffer::get_stencil_format(DXGI_FORMAT format)
{
    switch (format)
    {
    // 32-bit Z w/ Stencil
...
DXGI_FORMAT pixel_buffer::get_depth_format(DXGI_FORMAT format)
{
    switch (format)
    {
    // 32-bit Z w/ Stencil
...
DXGI_FORMAT pixel_buffer::get_uav_format(DXGI_FORMAT format)
{
    switch (format)
    {
